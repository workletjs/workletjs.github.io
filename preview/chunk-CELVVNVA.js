...
`,ae=mo(),le=class{constructor(){this.uniforms_=[],this.attributes_=[],this.hasSymbol_=!1,this.symbolSizeExpression_=`vec2(${De(ae["circle-radius"])} + ${De(ae["circle-stroke-width"]*.5)})`,this.symbolRotationExpression_="0.0",this.symbolOffsetExpression_="vec2(0.0)",this.symbolColorExpression_=Te(ae["circle-fill-color"]),this.texCoordExpression_="vec4(0.0, 0.0, 1.0, 1.0)",this.discardExpression_="false",this.symbolRotateWithView_=!1,this.hasStroke_=!1,this.strokeWidthExpression_=De(ae["stroke-width"]),this.strokeColorExpression_=Te(ae["stroke-color"]),this.strokeOffsetExpression_="0.",this.strokeCapExpression_=j("round"),this.strokeJoinExpression_=j("round"),this.strokeMiterLimitExpression_="10.",this.strokeDistanceFieldExpression_="-1000.",this.hasFill_=!1,this.fillColorExpression_=Te(ae["fill-color"]),this.vertexShaderFunctions_=[],this.fragmentShaderFunctions_=[]}addUniform(e,o){return this.uniforms_.push({name:e,type:o}),this}addAttribute(e,o,t,n){return this.attributes_.push({name:e,type:o,varyingName:e.replace(/^a_/,"v_"),varyingType:n??o,varyingExpression:t??e}),this}setSymbolSizeExpression(e){return this.hasSymbol_=!0,this.symbolSizeExpression_=e,this}getSymbolSizeExpression(){return this.symbolSizeExpression_}setSymbolRotationExpression(e){return this.symbolRotationExpression_=e,this}setSymbolOffsetExpression(e){return this.symbolOffsetExpression_=e,this}getSymbolOffsetExpression(){return this.symbolOffsetExpression_}setSymbolColorExpression(e){return this.hasSymbol_=!0,this.symbolColorExpression_=e,this}getSymbolColorExpression(){return this.symbolColorExpression_}setTextureCoordinateExpression(e){return this.texCoordExpression_=e,this}setFragmentDiscardExpression(e){return this.discardExpression_=e,this}getFragmentDiscardExpression(){return this.discardExpression_}setSymbolRotateWithView(e){return this.symbolRotateWithView_=e,this}setStrokeWidthExpression(e){return this.hasStroke_=!0,this.strokeWidthExpression_=e,this}setStrokeColorExpression(e){return this.hasStroke_=!0,this.strokeColorExpression_=e,this}getStrokeColorExpression(){return this.strokeColorExpression_}setStrokeOffsetExpression(e){return this.strokeOffsetExpression_=e,this}setStrokeCapExpression(e){return this.strokeCapExpression_=e,this}setStrokeJoinExpression(e){return this.strokeJoinExpression_=e,this}setStrokeMiterLimitExpression(e){return this.strokeMiterLimitExpression_=e,this}setStrokeDistanceFieldExpression(e){return this.strokeDistanceFieldExpression_=e,this}setFillColorExpression(e){return this.hasFill_=!0,this.fillColorExpression_=e,this}getFillColorExpression(){return this.fillColorExpression_}addVertexShaderFunction(e){return this.vertexShaderFunctions_.includes(e)?this:(this.vertexShaderFunctions_.push(e),this)}addFragmentShaderFunction(e){return this.fragmentShaderFunctions_.includes(e)?this:(this.fragmentShaderFunctions_.push(e),this)}getSymbolVertexShader(){return this.hasSymbol_?`${se}
...
`)}
}`:null}getSymbolFragmentShader(){return this.hasSymbol_?`${se}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec2 v_texCoord;
varying vec4 v_hitColor;
...
}`:null}getStrokeVertexShader(){return this.hasStroke_?`${se}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
...
${this.attributes_.map(e=>`  ${e.varyingName} = ${e.varyingExpression};`).join(`
`)}
}`:null}getStrokeFragmentShader(){return this.hasStroke_?`${se}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec2 v_segmentStart;
varying vec2 v_segmentEnd;
...
float miterJoinDistanceField(vec2 point, vec2 start, vec2 end, float width, float joinAngle) {
  if (cos(joinAngle) > ${nt}) { // avoid risking a division by zero
...
}`:null}getFillVertexShader(){return this.hasFill_?`${se}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
attribute vec2 a_position;
attribute vec4 a_hitColor;
...
${this.attributes_.map(e=>`  ${e.varyingName} = ${e.varyingExpression};`).join(`
`)}
}`:null}getFillFragmentShader(){return this.hasFill_?`${se}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec4 v_hitColor;
${this.attributes_.map(e=>`varying ${e.varyingType} ${e.varyingName};`).join(`
...
}`,st(i,e,t,"shape-");let n=null;"shape-opacity"in i&&(n=m(t,i["shape-opacity"],v));let r="coordsPx";"shape-scale"in i&&(r=`coordsPx / ${m(t,i["shape-scale"],oe)}`);let s=null;"shape-fill-color"in i&&(s=m(t,i["shape-fill-color"],K));let a=null;"shape-stroke-color"in i&&(a=m(t,i["shape-stroke-color"],K));let c=null;"shape-stroke-width"in i&&(c=m(t,i["shape-stroke-width"],v));let l=m(t,i["shape-points"],v),u="0.";"shape-angle"in i&&(u=m(t,i["shape-angle"],v));let h,d=m(t,i["shape-radius"],v);if(c!==null&&(d=`${d} + ${c} * 0.5`),"shape-radius2"in i){let w=m(t,i["shape-radius2"],v);c!==null&&(w=`${w} + ${c} * 0.5`),h=`starDistanceField(${r}, ${l}, ${d}, ${w}, ${u})`}else h=`regularDistanceField(${r}, ${l}, ${d}, ${u})`;let p=Ro(h,s,a,c,n);e.setSymbolColorExpression(p)}function Xo(i,e,o,t){let n="vec4(1.0)";"icon-color"in i&&(n=m(t,i["icon-color"],K)),"icon-opacity"in i&&(n=`${n} * vec4(1.0, 1.0, 1.0, ${m(t,i["icon-opacity"],v)})`);let r=Oe(i["icon-src"]),s=at(i,e,o,"icon-",r);if(e.setSymbolColorExpression(`${n} * texture2D(u_texture${r}, v_texCoord)`).setSymbolSizeExpression(s),"icon-width"in i&&"icon-height"in i&&e.setSymbolSizeExpression(`vec2(${m(t,i["icon-width"],v)}, ${m(t,i["icon-height"],v)})`),"icon-offset"in i&&"icon-size"in i){let a=m(t,i["icon-size"],te),c=e.getSymbolSizeExpression();e.setSymbolSizeExpression(a);let l=lt(i,"icon-",t,"v_quadSizePx",a);e.setTextureCoordinateExpression(`(vec4((${l}).xyxy) + vec4(0., 0., ${a})) / (${c}).xyxy`)}if(st(i,e,t,"icon-"),"icon-anchor"in i){let a=m(t,i["icon-anchor"],te),c="1.0";"icon-scale"in i&&(c=m(t,i["icon-scale"],oe));let l;i["icon-anchor-x-units"]==="pixels"&&i["icon-anchor-y-units"]==="pixels"?l=`${a} * ${c}`:i["icon-anchor-x-units"]==="pixels"?l=`${a} * vec2(vec2(${c}).x, v_quadSizePx.y)`:i["icon-anchor-y-units"]==="pixels"?l=`${a} * vec2(v_quadSizePx.x, vec2(${c}).x)`:l=`${a} * v_quadSizePx`;let u=`v_quadSizePx * vec2(0.5, -0.5) + ${l} * vec2(-1., 1.)`;if("icon-anchor-origin"in i)switch(i["icon-anchor-origin"]){case"top-right":u=`v_quadSizePx * -0.5 + ${l}`;break;case"bottom-left":u=`v_quadSizePx * 0.5 - ${l}`;break;case"bottom-right":u=`v_quadSizePx * vec2(-0.5, 0.5) + ${l} * vec2(1., -1.)`;break;default:}e.setSymbolOffsetExpression(`${e.getSymbolOffsetExpression()} + ${u}`)}}function qo(i,e,o,t){if("stroke-color"in i&&e.setStrokeColorExpression(m(t,i["stroke-color"],K)),"stroke-pattern-src"in i){let n=Oe(i["stroke-pattern-src"]),r=at(i,e,o,"stroke-pattern-",n),s=r,a="vec2(0.)";"stroke-pattern-offset"in i&&"stroke-pattern-size"in i&&(s=m(t,i["stroke-pattern-size"],te),a=lt(i,"stroke-pattern-",t,r,s));let c="0.";"stroke-pattern-spacing"in i&&(c=m(t,i["stroke-pattern-spacing"],v)),t.functions.sampleStrokePattern=`vec4 sampleStrokePattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, float spacingPx, float currentLengthPx, float currentRadiusRatio, float lineWidth) {
...
}`;let n=i["stroke-line-dash"].map(p=>m(t,p,v));n.length%2===1&&(n=[...n,...n]);let r="0.";"stroke-line-dash-offset"in i&&(r=m(t,i["stroke-line-dash-offset"],v));let a=`dashDistanceField_${Oe(i["stroke-line-dash"])}`,c=n.map((p,w)=>`float dashLength${w}`).join(", "),l=n.map((p,w)=>`dashLength${w}`).join(" + "),u="0.",h=`getSingleDashDistance(distance, radius, ${u}, dashLength0, totalDashLength, capType, lineWidth)`;for(let p=2;p<n.length;p+=2)u=`${u} + dashLength${p-2} + dashLength${p-1}`,h=`min(${h}, getSingleDashDistance(distance, radius, ${u}, dashLength${p}, totalDashLength, capType, lineWidth))`;t.functions[a]=`float ${a}(float distance, float radius, float capType, float lineWidth, ${c}) {
  float totalDashLength = ${l};
  return ${h};
}`;let d=n.map((p,w)=>`${p}`).join(", ");e.setStrokeDistanceFieldExpression(`${a}(currentLengthPx + ${r}, currentRadiusPx, capType, v_width, ${d})`)}}function Jo(i,e,o,t){if("fill-color"in i&&e.setFillColorExpression(m(t,i["fill-color"],K)),"fill-pattern-src"in i){let n=Oe(i["fill-pattern-src"]),r=at(i,e,o,"fill-pattern-",n),s=r,a="vec2(0.)";"fill-pattern-offset"in i&&"fill-pattern-size"in i&&(s=m(t,i["fill-pattern-size"],te),a=lt(i,"fill-pattern-",t,r,s)),t.functions.sampleFillPattern=`vec4 sampleFillPattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, vec2 pxOrigin, vec2 pxPosition) {
...
}`;let c=`u_texture${n}`,l="1.";"fill-color"in i&&(l=e.getFillColorExpression()),e.setFillColorExpression(`${l} * sampleFillPattern(${c}, ${r}, ${a}, ${s}, pxOrigin, pxPos)`)}}function So(i,e,o){let t=Le(),n=new le,r={};if("icon-src"in i?Xo(i,n,r,t):"shape-points"in i?Ko(i,n,r,t):"circle-radius"in i&&Ho(i,n,r,t),qo(i,n,r,t),Jo(i,n,r,t),o){let c=m(t,o,ee);n.setFragmentDiscardExpression(`!${c}`)}let s={};function a(c,l,u,h){if(!t[c])return;let d=Yt(u),p=Jt(u);n.addAttribute(`a_${l}`,d),s[l]={size:p,callback:h}}return a("geometryType",qt,ge,c=>Je(Me(c.getGeometry()))),a("featureId",Xt,ge|v,c=>{let l=c.getId()??null;return typeof l=="string"?Je(l):l}),ke(n,t),{builder:n,attributes:F(F({},s),Ve(t)),uniforms:F(F({},r),Ne(t,e))}}function Co(i){let e=Array.isArray(i)?i:[i];if("style"in e[0]){let o=[],t=e,n=[];for(let r of t){let s=Array.isArray(r.style)?r.style:[r.style],a=r.filter;r.else&&n.length&&(a=["all",...n.map(l=>["!",l])],r.filter&&a.push(r.filter),a.length<3&&(a=a[1])),r.filter&&n.push(r.filter);let c=s.map(l=>F({style:l},a&&{filter:a}));o.push(...c)}return o}return"builder"in e[0]?e:e.map(o=>({style:o}))}var Yo=[],ct;function Qo(){return ct||(ct=wo()),ct}var en=0,W={POSITION:"a_position",INDEX:"a_index",SEGMENT_START:"a_segmentStart",SEGMENT_END:"a_segmentEnd",MEASURE_START:"a_measureStart",MEASURE_END:"a_measureEnd",PARAMETERS:"a_parameters",JOIN_ANGLES:"a_joinAngles",DISTANCE:"a_distance"},ut=class{constructor(e,o,t,n,r){this.helper_,this.hitDetectionEnabled_=!!n;let s=e;if(!("builder"in e)){let u=e,h=So(u.style,o,u.filter);s={builder:h.builder,attributes:h.attributes,uniforms:h.uniforms}}this.fillProgram_,this.strokeProgram_,this.symbolProgram_,this.hasFill_=!!s.builder.getFillVertexShader(),this.hasFill_&&(this.fillVertexShader_=s.builder.getFillVertexShader(),this.fillFragmentShader_=s.builder.getFillFragmentShader()),this.hasStroke_=!!s.builder.getStrokeVertexShader(),this.hasStroke_&&(this.strokeVertexShader_=s.builder.getStrokeVertexShader(),this.strokeFragmentShader_=s.builder.getStrokeFragmentShader()),this.hasSymbol_=!!s.builder.getSymbolVertexShader(),this.hasSymbol_&&(this.symbolVertexShader_=s.builder.getSymbolVertexShader(),this.symbolFragmentShader_=s.builder.getSymbolFragmentShader()),this.featureFilter_=null,r&&(this.featureFilter_=this.computeFeatureFilter(r));let c=this.hitDetectionEnabled_?{hitColor:{callback(){return yo(this.ref,Yo)},size:4}}:{};this.customAttributes_=Object.assign({},c,s.attributes),this.uniforms_=s.uniforms;let l=Object.entries(this.customAttributes_).map(([u,h])=>({name:`a_${u}`,size:h.size||1,type:A.FLOAT}));this.polygonAttributesDesc_=[{name:W.POSITION,size:2,type:A.FLOAT},...l],this.lineStringAttributesDesc_=[{name:W.SEGMENT_START,size:2,type:A.FLOAT},{name:W.MEASURE_START,size:1,type:A.FLOAT},{name:W.SEGMENT_END,size:2,type:A.FLOAT},{name:W.MEASURE_END,size:1,type:A.FLOAT},{name:W.JOIN_ANGLES,size:2,type:A.FLOAT},{name:W.DISTANCE,size:1,type:A.FLOAT},{name:W.PARAMETERS,size:1,type:A.FLOAT},...l],this.pointAttributesDesc_=[{name:W.POSITION,size:2,type:A.FLOAT},{name:W.INDEX,size:1,type:A.FLOAT},...l],this.setHelper(t)}computeFeatureFilter(e){let o=Bt(),t;try{t=Zt(e,ee,o)}catch{return null}if(o.mapState||o.variables.size>0)return null;let n=$t();return r=>{if(n.properties=r.getPropertiesInternal(),o.featureId){let s=r.getId();s!==void 0?n.featureId=s:n.featureId=null}return n.geometryType=Me(r.getGeometry()),t(n)}}generateBuffers(e,o){return wt(this,null,function*(){let t=e;if(this.featureFilter_&&(t=t.filter(this.featureFilter_),t.isEmpty()))return null;let n=this.generateRenderInstructions_(t,o),[r,s,a]=yield Promise.all([this.generateBuffersForType_(n.polygonInstructions,"Polygon",o),this.generateBuffersForType_(n.lineStringInstructions,"LineString",o),this.generateBuffersForType_(n.pointInstructions,"Point",o)]),c=pe(z(),o);return{polygonBuffers:r,lineStringBuffers:s,pointBuffers:a,invertVerticesTransform:c}})}generateRenderInstructions_(e,o){let t=this.hasFill_?Eo(e.polygonBatch,new Float32Array(0),this.customAttributes_,o):null,n=this.hasStroke_?bo(e.lineStringBatch,new Float32Array(0),this.customAttributes_,o):null,r=this.hasSymbol_?_o(e.pointBatch,new Float32Array(0),this.customAttributes_,o):null;return{polygonInstructions:t,lineStringInstructions:n,pointInstructions:r}}generateBuffersForType_(e,o,t){if(e===null)return null;let n=en++,r;switch(o){case"Polygon":r=Ae.GENERATE_POLYGON_BUFFERS;break;case"LineString":r=Ae.GENERATE_LINE_STRING_BUFFERS;break;case"Point":r=Ae.GENERATE_POINT_BUFFERS;break;default:}let s={id:n,type:r,renderInstructions:e.buffer,renderInstructionsTransform:t,customAttributesSize:we(this.customAttributes_)},a=Qo();return a.postMessage(s,[e.buffer]),e=null,new Promise(c=>{let l=u=>{let h=u.data;if(h.id!==n||(a.removeEventListener("message",l),!this.helper_.getGL()))return;let d=new qe(zt,Xe).fromArrayBuffer(h.vertexBuffer),p=new qe(Ut,Xe).fromArrayBuffer(h.indexBuffer);this.helper_.flushBufferData(d),this.helper_.flushBufferData(p),c([p,d])};a.addEventListener("message",l)})}render(e,o,t){this.hasFill_&&this.renderInternal_(e.polygonBuffers[0],e.polygonBuffers[1],this.fillProgram_,this.polygonAttributesDesc_,o,t),this.hasStroke_&&this.renderInternal_(e.lineStringBuffers[0],e.lineStringBuffers[1],this.strokeProgram_,this.lineStringAttributesDesc_,o,t),this.hasSymbol_&&this.renderInternal_(e.pointBuffers[0],e.pointBuffers[1],this.symbolProgram_,this.pointAttributesDesc_,o,t)}renderInternal_(e,o,t,n,r,s){let a=e.getSize();a!==0&&(this.helper_.useProgram(t,r),this.helper_.bindBuffer(o),this.helper_.bindBuffer(e),this.helper_.enableAttributes(n),s(),this.helper_.drawElements(0,a))}setHelper(e,o=null){this.helper_=e,this.hasFill_&&(this.fillProgram_=this.helper_.getProgram(this.fillFragmentShader_,this.fillVertexShader_)),this.hasStroke_&&(this.strokeProgram_=this.helper_.getProgram(this.strokeFragmentShader_,this.strokeVertexShader_)),this.hasSymbol_&&(this.symbolProgram_=this.helper_.getProgram(this.symbolFragmentShader_,this.symbolVertexShader_)),this.helper_.addUniforms(this.uniforms_),o&&(o.polygonBuffers&&(this.helper_.flushBufferData(o.polygonBuffers[0]),this.helper_.flushBufferData(o.polygonBuffers[1])),o.lineStringBuffers&&(this.helper_.flushBufferData(o.lineStringBuffers[0]),this.helper_.flushBufferData(o.lineStringBuffers[1])),o.pointBuffers&&(this.helper_.flushBufferData(o.pointBuffers[0]),this.helper_.flushBufferData(o.pointBuffers[1])))}},Po=ut;var G=new Uint8Array(4),ht=class{constructor(e,o){this.helper_=e;let t=e.getGL();this.texture_=t.createTexture(),this.framebuffer_=t.createFramebuffer(),this.depthbuffer_=t.createRenderbuffer(),this.size_=o||[1,1],this.data_=new Uint8Array(0),this.dataCacheDirty_=!0,this.updateSize_()}setSize(e){be(e,this.size_)||(this.size_[0]=e[0],this.size_[1]=e[1],this.updateSize_())}getSize(){return this.size_}clearCachedData(){this.dataCacheDirty_=!0}readAll(){if(this.dataCacheDirty_){let e=this.size_,o=this.helper_.getGL();o.bindFramebuffer(o.FRAMEBUFFER,this.framebuffer_),o.readPixels(0,0,e[0],e[1],o.RGBA,o.UNSIGNED_BYTE,this.data_),this.dataCacheDirty_=!1}return this.data_}readPixel(e,o){if(e<0||o<0||e>this.size_[0]||o>=this.size_[1])return G[0]=0,G[1]=0,G[2]=0,G[3]=0,G;this.readAll();let t=Math.floor(e)+(this.size_[1]-Math.floor(o)-1)*this.size_[0];return G[0]=this.data_[t*4],G[1]=this.data_[t*4+1],G[2]=this.data_[t*4+2],G[3]=this.data_[t*4+3],G}getTexture(){return this.texture_}getFramebuffer(){return this.framebuffer_}getDepthbuffer(){return this.depthbuffer_}updateSize_(){let e=this.size_,o=this.helper_.getGL();this.texture_=this.helper_.createTexture(e,null,this.texture_),o.bindFramebuffer(o.FRAMEBUFFER,this.framebuffer_),o.viewport(0,0,e[0],e[1]),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,this.texture_,0),o.bindRenderbuffer(o.RENDERBUFFER,this.depthbuffer_),o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_COMPONENT16,e[0],e[1]),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,this.depthbuffer_),this.data_=new Uint8Array(e[0]*e[1]*4)}},Fo=ht;function Mo(i,e){let o=i.viewState.projection,n=e.getSource().getWrapX()&&o.canWrapX(),r=o.getExtent(),s=i.extent,a=n?Z(r):null,c=n?Math.ceil((s[2]-r[2])/a)+1:1;return[n?Math.floor((s[0]-r[0])/a):0,c,a]}var ce=xt(F({},Ht),{RENDER_EXTENT:"u_renderExtent",PATTERN_ORIGIN:"u_patternOrigin",GLOBAL_ALPHA:"u_globalAlpha"}),dt=class extends Kt{constructor(e,o){let t={[ce.RENDER_EXTENT]:[0,0,0,0],[ce.PATTERN_ORIGIN]:[0,0],[ce.GLOBAL_ALPHA]:1};super(e,{uniforms:t,postProcesses:o.postProcesses}),this.hitDetectionEnabled_=!o.disableHitDetection,this.hitRenderTarget_,this.sourceRevision_=-1,this.previousExtent_=de(),this.currentTransform_=z(),this.tmpCoords_=[0,0],this.tmpTransform_=z(),this.tmpMat4_=Gt(),this.currentFrameStateTransform_=z(),this.styleVariables_={},this.styles_=[],this.styleRenderers_=[],this.buffers_=[],this.applyOptions_(o),this.batch_=new xo,this.initialFeaturesAdded_=!1,this.sourceListenKeys_=null}addInitialFeatures_(e){let o=this.getLayer().getSource(),t=Q(),n;t&&(n=Ce(t,e.viewState.projection)),this.batch_.addFeatures(o.getFeatures(),n),this.sourceListenKeys_=[ue(o,me.ADDFEATURE,this.handleSourceFeatureAdded_.bind(this,n)),ue(o,me.CHANGEFEATURE,this.handleSourceFeatureChanged_.bind(this,n),this),ue(o,me.REMOVEFEATURE,this.handleSourceFeatureDelete_,this),ue(o,me.CLEAR,this.handleSourceFeatureClear_,this)]}applyOptions_(e){this.styleVariables_=e.variables,this.styles_=Co(e.style)}createRenderers_(){this.buffers_=[],this.styleRenderers_=this.styles_.map(e=>new Po(e,this.styleVariables_,this.helper,this.hitDetectionEnabled_,"filter"in e?e.filter:null))}reset(e){this.applyOptions_(e),this.helper&&this.createRenderers_(),super.reset(e)}afterHelperCreated(){this.styleRenderers_.length?this.styleRenderers_.forEach((e,o)=>e.setHelper(this.helper,this.buffers_[o])):this.createRenderers_(),this.hitDetectionEnabled_&&(this.hitRenderTarget_=new Fo(this.helper))}handleSourceFeatureAdded_(e,o){let t=o.feature;this.batch_.addFeature(t,e)}handleSourceFeatureChanged_(e,o){let t=o.feature;this.batch_.changeFeature(t,e)}handleSourceFeatureDelete_(e){let o=e.feature;this.batch_.removeFeature(o)}handleSourceFeatureClear_(){this.batch_.clear()}applyUniforms_(e){Lt(this.tmpTransform_,this.currentFrameStateTransform_),Tt(this.tmpTransform_,e),this.helper.setUniformMatrixValue(ce.PROJECTION_MATRIX,Ke(this.tmpMat4_,this.tmpTransform_)),pe(this.tmpTransform_,this.tmpTransform_),this.helper.setUniformMatrixValue(ce.SCREEN_TO_WORLD_MATRIX,Ke(this.tmpMat4_,this.tmpTransform_)),this.tmpCoords_[0]=0,this.tmpCoords_[1]=0,pe(this.tmpTransform_,e),H(this.tmpTransform_,this.tmpCoords_),this.helper.setUniformFloatVec2(ce.PATTERN_ORIGIN,this.tmpCoords_)}renderFrame(e){let o=this.helper.getGL();this.preRender(o,e);let[t,n,r]=Mo(e,this.getLayer());this.helper.prepareDraw(e),this.renderWorlds(e,!1,t,n,r),this.helper.finalizeDraw(e,this.dispatchPreComposeEvent,this.dispatchPostComposeEvent);let s=this.helper.getCanvas();return this.hitDetectionEnabled_&&(this.renderWorlds(e,!0,t,n,r),this.hitRenderTarget_.clearCachedData()),this.postRender(o,e),s}prepareFrameInternal(e){this.initialFeaturesAdded_||(this.addInitialFeatures_(e),this.initialFeaturesAdded_=!0);let o=this.getLayer(),t=o.getSource(),n=e.viewState,r=!e.viewHints[B.ANIMATING]&&!e.viewHints[B.INTERACTING],s=!Rt(this.previousExtent_,e.extent),a=this.sourceRevision_<t.getRevision();if(a&&(this.sourceRevision_=t.getRevision()),r&&(s||a)){let c=n.projection,l=n.resolution,u=o instanceof X?o.getRenderBuffer():0,h=Re(e.extent,u*l),d=Q();d?t.loadFeatures(fe(h,d),Pe(l,c),d):t.loadFeatures(h,l,c),this.ready=!1;let p=this.helper.makeProjectionTransform(e,z()),w=this.styleRenderers_.map((_,y)=>_.generateBuffers(this.batch_,p).then(b=>{this.buffers_[y]&&this.disposeBuffers(this.buffers_[y]),this.buffers_[y]=b}));Promise.all(w).then(()=>{this.ready=!0,this.getLayer().changed()}),this.previousExtent_=e.extent.slice()}return!0}renderWorlds(e,o,t,n,r){let s=t;o&&(this.hitRenderTarget_.setSize([Math.floor(e.size[0]/2),Math.floor(e.size[1]/2)]),this.helper.prepareDrawToRenderTarget(e,this.hitRenderTarget_,!0));do{this.helper.makeProjectionTransform(e,this.currentFrameStateTransform_),kt(this.currentFrameStateTransform_,s*r,0);for(let a=0,c=this.styleRenderers_.length;a<c;a++){let l=this.styleRenderers_[a],u=this.buffers_[a];u&&l.render(u,e,()=>{this.applyUniforms_(u.invertVerticesTransform),this.helper.applyHitDetectionUniform(o)})}}while(++s<n)}forEachFeatureAtCoordinate(e,o,t,n,r){if(Ee(this.hitDetectionEnabled_,"`forEachFeatureAtCoordinate` cannot be used on a WebGL layer if the hit detection logic has been disabled using the `disableHitDetection: true` option."),!this.styleRenderers_.length||!this.hitDetectionEnabled_)return;let s=H(o.coordinateToPixelTransform,e.slice()),a=this.hitRenderTarget_.readPixel(s[0]/2,s[1]/2),c=[a[0]/255,a[1]/255,a[2]/255,a[3]/255],l=vo(c),u=this.batch_.getFeatureFromRef(l);if(u)return n(u,this.getLayer(),null)}disposeBuffers(e){let o=t=>{for(let n of t)n&&this.helper.deleteBuffer(n)};e.pointBuffers&&o(e.pointBuffers),e.lineStringBuffers&&o(e.lineStringBuffers),e.polygonBuffers&&o(e.polygonBuffers)}disposeInternal(){this.buffers_.forEach(e=>{e&&this.disposeBuffers(e)}),this.sourceListenKeys_&&(this.sourceListenKeys_.forEach(function(e){bt(e)}),this.sourceListenKeys_=null),super.disposeInternal()}renderDeclutter(){}},Be=dt;var U={BLUR:"blur",GRADIENT:"gradient",RADIUS:"radius"},tn=["#00f","#0ff","#0f0","#ff0","#f00"],ft=class extends X{constructor(e){e=e||{};let o=Object.assign({},e);delete o.gradient,delete o.radius,delete o.blur,delete o.weight,super(o),this.filter_=e.filter??!0,this.styleVariables_=e.variables||{},this.gradient_=null,this.addChangeListener(U.GRADIENT,this.handleGradientChanged_),this.setGradient(e.gradient?e.gradient:tn),this.setBlur(e.blur!==void 0?e.blur:15),this.setRadius(e.radius!==void 0?e.radius:8);let t=e.weight?e.weight:"weight";this.weight_=t,this.setRenderOrder(null)}getBlur(){return this.get(U.BLUR)}getGradient(){return this.get(U.GRADIENT)}getRadius(){return this.get(U.RADIUS)}handleGradientChanged_(){this.gradient_=on(this.getGradient())}setBlur(e){let o=this.get(U.BLUR);if(this.set(U.BLUR,e),typeof e=="number"&&typeof o=="number"){this.changed();return}this.clearRenderer()}setGradient(e){this.set(U.GRADIENT,e)}setRadius(e){let o=this.get(U.RADIUS);if(this.set(U.RADIUS,e),typeof e=="number"&&typeof o=="number"){this.changed();return}this.clearRenderer()}setFilter(e){this.filter_=e,this.changed(),this.clearRenderer()}setWeight(e){this.weight_=e,this.changed(),this.clearRenderer()}createRenderer(){let e=new le,o=Le(),t=m(o,this.filter_,ee),n=m(o,this.getRadius(),v),r=m(o,this.getBlur(),v),s={};typeof this.getBlur()=="number"&&(r="a_blur",s.a_blur=()=>this.getBlur(),e.addUniform("a_blur","float")),typeof this.getRadius()=="number"&&(n="a_radius",s.a_radius=()=>this.getRadius(),e.addUniform("a_radius","float"));let a={},c=null;if(typeof this.weight_=="string"||typeof this.weight_=="function"){let h=typeof this.weight_=="string"?d=>d.get(this.weight_):this.weight_;a.prop_weight={size:1,callback:d=>{let p=h(d);return p!==void 0?Et(p,0,1):1}},c="a_prop_weight",e.addAttribute("a_prop_weight","float")}else{let h=["clamp",this.weight_,0,1];c=m(o,h,v)}e.addFragmentShaderFunction(`float getBlurSlope() {
  float blur = max(1., ${r});
  float radius = ${n};
  return radius / blur;
}`).setSymbolSizeExpression(`vec2(${n} + ${r}) * 2.`).setSymbolColorExpression(`vec4(smoothstep(0., 1., (1. - length(coordsPx * 2. / v_quadSizePx)) * getBlurSlope()) * ${c})`).setStrokeColorExpression(`vec4(smoothstep(0., 1., (1. - length(currentRadiusPx * 2. / v_width)) * getBlurSlope()) * ${c})`).setStrokeWidthExpression(`(${n} + ${r}) * 2.`).setFillColorExpression(`vec4(${c})`).setFragmentDiscardExpression(`!${t}`),ke(e,o);let l=Ve(o),u=Ne(o,this.styleVariables_);return new Be(this,{className:this.getClassName(),variables:this.styleVariables_,style:{builder:e,attributes:F(F({},l),a),uniforms:F(F({},u),s)},disableHitDetection:!1,postProcesses:[{fragmentShader:`
            precision mediump float;
