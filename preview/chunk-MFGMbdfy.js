import {v as ve}from'./chunk-BVHigRE1.js';import {G,B as B$1}from'./chunk-P6K8BW6b.js';import {P}from'./chunk-CQ2Gaunh.js';import {t as ti}from'./chunk-C9ZOTp3n.js';import {B,H as Ht,L,v as vn,E as En,e as ae$1,Y as Y$1,$,U as Un,h as he$1,u as ue$1}from'./chunk-LWjUFHXm.js';import {Q as pv,z as ze,V,m as _e}from'./chunk-BV7Laz5-.js';import {g as gc,n as m$,b as g$,br as Z,p as p$1,c as Ee,l as Wa,h as hf,f as fo,W as Wn,q as x,t as w,K as Kt,G as GT,m as WT}from'./main-QSB3FXRL.js';var i={TEXTURE:"u_texture",VELOCITY_TEXTURE:"u_velocityTexture",POSITION_TEXTURE:"u_positionTexture",PARTICLE_COUNT_SQRT:"u_particleCountSqrt",MAX_SPEED:"u_maxSpeed",RANDOM_SEED:"u_randomSeed",SPEED_FACTOR:"u_speedFactor",DROP_RATE:"u_dropRate",DROP_RATE_BUMP:"u_dropRateBump",OPACITY:"u_opacity",ROTATION:B.ROTATION,VIEWPORT_SIZE_PX:B.VIEWPORT_SIZE_PX},T={POSITION:"a_position",INDEX:"a_index"},p={POSITION:"v_position"},M=class extends En{constructor(r,e){super(r,{vertexShader:e.tileVertexShader,fragmentShader:e.tileFragmentShader,cacheSize:e.cacheSize,postProcesses:[{}],uniforms:{[i.MAX_SPEED]:e.maxSpeed}}),this.particleColorFragmentShader_=e.particleColorFragmentShader,this.velocityTexture_=null,this.particleCountSqrt_=e.particles?Math.ceil(Math.sqrt(e.particles)):256,this.particleIndexBuffer_,this.quadBuffer_,this.particlePositionProgram_,this.particlePositionVertexShader_=e.particlePositionVertexShader,this.particlePositionFragmentShader_=e.particlePositionFragmentShader,this.previousPositionTexture_,this.nextPositionTexture_,this.particleColorProgram_,this.particleColorVertexShader_=e.particleColorVertexShader,this.particleColorFragmentShader_=e.particleColorFragmentShader,this.textureProgram_,this.textureVertexShader_=e.textureVertexShader,this.textureFragmentShader_=e.textureFragmentShader,this.previousTrailsTexture_,this.nextTrailsTexture_,this.fadeOpacity_=.996,this.maxSpeed_=e.maxSpeed,this.speedFactor_=e.speedFactor||.001,this.dropRate_=.003,this.dropRateBump_=.01,this.tempVec2_=[0,0],this.renderedWidth_=0,this.renderedHeight_=0;}afterHelperCreated(){super.afterHelperCreated();let r=this.helper,e=r.getGL();this.framebuffer_=e.createFramebuffer();let t=this.particleCountSqrt_*this.particleCountSqrt_,o=new Float32Array(t);for(let h=0;h<t;++h)o[h]=h;let n=new ae$1(Y$1,$);n.setArray(o),r.flushBufferData(n),this.particleIndexBuffer_=n;let a=new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),f=new ae$1(Y$1,$);f.setArray(a),r.flushBufferData(f),this.quadBuffer_=f;let u=new Uint8Array(t*4);for(let h=0;h<u.length;++h)u[h]=Math.floor(Math.random()*256);this.previousPositionTexture_=r.createTexture([this.particleCountSqrt_,this.particleCountSqrt_],u,null,true),this.nextPositionTexture_=r.createTexture([this.particleCountSqrt_,this.particleCountSqrt_],u,null,true),this.particlePositionProgram_=r.getProgram(this.particlePositionFragmentShader_,this.particlePositionVertexShader_),this.particleColorProgram_=r.getProgram(this.particleColorFragmentShader_,this.particleColorVertexShader_),this.textureProgram_=r.getProgram(this.textureFragmentShader_,this.textureVertexShader_);}createSizeDependentTextures_(){let r=this.helper,e=r.getGL(),t=r.getCanvas(),o=t.width,n=t.height,a=new Uint8Array(o*n*4);this.nextTrailsTexture_&&e.deleteTexture(this.nextTrailsTexture_),this.nextTrailsTexture_=r.createTexture([o,n],a,null,true),this.previousTrailsTexture_&&e.deleteTexture(this.previousTrailsTexture_),this.previousTrailsTexture_=r.createTexture([o,n],a,null,true);}beforeFinalize(r){let e=this.helper,t=e.getGL(),o=e.getCanvas(),n=o.width,a=o.height;(this.renderedWidth_!=n||this.renderedHeight_!=a)&&this.createSizeDependentTextures_();let f=[n,a];this.velocityTexture_=e.createTexture(f,null,this.velocityTexture_),t.copyTexImage2D(t.TEXTURE_2D,0,t.RGBA,0,0,n,a,0),this.drawParticleTrails_(r),this.updateParticlePositions_(r),r.animate=true,this.renderedWidth_=n,this.renderedHeight_=a;}drawParticleTrails_(r){let e=this.helper,t=e.getGL();e.bindFrameBuffer(this.framebuffer_,this.nextTrailsTexture_),this.drawTexture_(this.previousTrailsTexture_,this.fadeOpacity_),this.drawParticleColor_(r),e.bindInitialFrameBuffer(),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT),t.enable(t.BLEND),t.blendFunc(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA),this.drawTexture_(this.nextTrailsTexture_,1),t.disable(t.BLEND);let o=this.nextTrailsTexture_;this.nextTrailsTexture_=this.previousTrailsTexture_,this.previousTrailsTexture_=o;}drawTexture_(r,e){let t=this.helper,o=t.getGL();t.useProgram(this.textureProgram_),t.bindTexture(r,0,i.TEXTURE),t.bindAttribute(this.quadBuffer_,T.POSITION,2),this.helper.setUniformFloatValue(i.OPACITY,e),o.drawArrays(o.TRIANGLES,0,6);}drawParticleColor_(r){let e=this.helper,t=e.getGL();e.useProgram(this.particleColorProgram_);let o=this.particleCountSqrt_*this.particleCountSqrt_;e.bindAttribute(this.particleIndexBuffer_,T.INDEX,1),e.bindTexture(this.previousPositionTexture_,0,i.POSITION_TEXTURE),e.bindTexture(this.velocityTexture_,1,i.VELOCITY_TEXTURE),this.helper.setUniformFloatValue(i.PARTICLE_COUNT_SQRT,this.particleCountSqrt_);let n=this.tempVec2_;n[0]=Math.cos(-r.viewState.rotation),n[1]=Math.sin(-r.viewState.rotation),this.helper.setUniformFloatVec2(i.ROTATION,n),this.helper.setUniformFloatValue(i.MAX_SPEED,this.maxSpeed_),t.drawArrays(t.POINTS,0,o);}updateParticlePositions_(r){let e=this.helper,t=e.getGL();e.useProgram(this.particlePositionProgram_),t.viewport(0,0,this.particleCountSqrt_,this.particleCountSqrt_),e.bindFrameBuffer(this.framebuffer_,this.nextPositionTexture_),e.bindTexture(this.previousPositionTexture_,0,i.POSITION_TEXTURE),e.bindTexture(this.velocityTexture_,1,i.VELOCITY_TEXTURE),e.bindAttribute(this.quadBuffer_,T.POSITION,2),e.setUniformFloatValue(i.RANDOM_SEED,Math.random()),e.setUniformFloatValue(i.SPEED_FACTOR,this.speedFactor_),e.setUniformFloatValue(i.DROP_RATE,this.dropRate_),e.setUniformFloatValue(i.DROP_RATE_BUMP,this.dropRateBump_);let o=this.tempVec2_;o[0]=Math.cos(-r.viewState.rotation),o[1]=Math.sin(-r.viewState.rotation),this.helper.setUniformFloatVec2(i.ROTATION,o);let n=r.size;this.helper.setUniformFloatVec2(i.VIEWPORT_SIZE_PX,[n[0],n[1]]),t.drawArrays(t.TRIANGLES,0,6);let a=this.nextPositionTexture_;this.nextPositionTexture_=this.previousPositionTexture_,this.previousPositionTexture_=a;}},Q=M;var ae=`
  ...
  void main() {
    ...
    gl_Position = ${L.TILE_TRANSFORM} * vec4(${Ht.TEXTURE_COORD}, ${L.DEPTH}, 1.0);
  }
`,le=`
  ...
  uniform sampler2D ${L.TILE_TEXTURE_ARRAY}[1];
  ...
  void main() {
    ...
    vec4 velocity = texture2D(${L.TILE_TEXTURE_ARRAY}[0],  v_textureCoord);
...
`;function de(c){let r=Un(),e=[];if(c.color!==void 0){let u=vn(r,c.color,_e);e.push(`color = ${u};`);}let t=Object.keys(r.variables);if(t.length>1&&!c.variables)throw new Error(`Missing variables in style (expected ${r.variables})`);let o={};for(let u of t){if(!(u in c.variables))throw new Error(`Missing '${u}' in style variables`);let h=ue$1(u);o[h]=function(){let g=c.variables[u];return typeof g=="string"&&(g=he$1(g)),g!==void 0?g:-9999999};}let n=Object.keys(o).map(function(u){return `uniform float ${u};`}),a=Object.keys(r.functions).map(function(u){return r.functions[u]}),f=`
    #ifdef GL_FRAGMENT_PRECISION_HIGH
    precision highp float;
    #else
    precision mediump float;
