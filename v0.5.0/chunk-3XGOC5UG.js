...
}`,lt(i,e,t,"shape-");let n=null;"shape-opacity"in i&&(n=m(t,i["shape-opacity"],v));let r="coordsPx";"shape-scale"in i&&(r=`coordsPx / ${m(t,i["shape-scale"],oe)}`);let s=null;"shape-fill-color"in i&&(s=m(t,i["shape-fill-color"],K));let a=null;"shape-stroke-color"in i&&(a=m(t,i["shape-stroke-color"],K));let c=null;"shape-stroke-width"in i&&(c=m(t,i["shape-stroke-width"],v));let l=m(t,i["shape-points"],v),u="0.";"shape-angle"in i&&(u=m(t,i["shape-angle"],v));let h,d=m(t,i["shape-radius"],v);if(c!==null&&(d=`${d} + ${c} * 0.5`),"shape-radius2"in i){let w=m(t,i["shape-radius2"],v);c!==null&&(w=`${w} + ${c} * 0.5`),h=`starDistanceField(${r}, ${l}, ${d}, ${w}, ${u})`}else h=`regularDistanceField(${r}, ${l}, ${d}, ${u})`;let p=Co(h,s,a,c,n);e.setSymbolColorExpression(p)}function qo(i,e,o,t){let n="vec4(1.0)";"icon-color"in i&&(n=m(t,i["icon-color"],K)),"icon-opacity"in i&&(n=`${n} * vec4(1.0, 1.0, 1.0, ${m(t,i["icon-opacity"],v)})`);let r=Be(i["icon-src"]),s=ct(i,e,o,"icon-",r);if(e.setSymbolColorExpression(`${n} * texture2D(u_texture${r}, v_texCoord)`).setSymbolSizeExpression(s),"icon-width"in i&&"icon-height"in i&&e.setSymbolSizeExpression(`vec2(${m(t,i["icon-width"],v)}, ${m(t,i["icon-height"],v)})`),"icon-offset"in i&&"icon-size"in i){let a=m(t,i["icon-size"],te),c=e.getSymbolSizeExpression();e.setSymbolSizeExpression(a);let l=ut(i,"icon-",t,"v_quadSizePx",a);e.setTextureCoordinateExpression(`(vec4((${l}).xyxy) + vec4(0., 0., ${a})) / (${c}).xyxy`)}if(lt(i,e,t,"icon-"),"icon-anchor"in i){let a=m(t,i["icon-anchor"],te),c="1.0";"icon-scale"in i&&(c=m(t,i["icon-scale"],oe));let l;i["icon-anchor-x-units"]==="pixels"&&i["icon-anchor-y-units"]==="pixels"?l=`${a} * ${c}`:i["icon-anchor-x-units"]==="pixels"?l=`${a} * vec2(vec2(${c}).x, v_quadSizePx.y)`:i["icon-anchor-y-units"]==="pixels"?l=`${a} * vec2(v_quadSizePx.x, vec2(${c}).x)`:l=`${a} * v_quadSizePx`;let u=`v_quadSizePx * vec2(0.5, -0.5) + ${l} * vec2(-1., 1.)`;if("icon-anchor-origin"in i)switch(i["icon-anchor-origin"]){case"top-right":u=`v_quadSizePx * -0.5 + ${l}`;break;case"bottom-left":u=`v_quadSizePx * 0.5 - ${l}`;break;case"bottom-right":u=`v_quadSizePx * vec2(-0.5, 0.5) + ${l} * vec2(1., -1.)`;break;default:}e.setSymbolOffsetExpression(`${e.getSymbolOffsetExpression()} + ${u}`)}}function Jo(i,e,o,t){if("stroke-color"in i&&e.setStrokeColorExpression(m(t,i["stroke-color"],K)),"stroke-pattern-src"in i){let n=Be(i["stroke-pattern-src"]),r=ct(i,e,o,"stroke-pattern-",n),s=r,a="vec2(0.)";"stroke-pattern-offset"in i&&"stroke-pattern-size"in i&&(s=m(t,i["stroke-pattern-size"],te),a=ut(i,"stroke-pattern-",t,r,s));let c="0.";"stroke-pattern-spacing"in i&&(c=m(t,i["stroke-pattern-spacing"],v)),t.functions.sampleStrokePattern=`vec4 sampleStrokePattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, float spacingPx, float currentLengthPx, float currentRadiusRatio, float lineWidth) {
