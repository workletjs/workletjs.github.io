import {aW as E,p,ar as fr,at as K,O as lo,o as xt$1,bV as he,dm as l,h as hf,cb as Zn,dn as it,bu as G,bR as Le,by as bt$1,bz as Ht,cw as w$,aM as Ps,bH as wM,I as Ie,bx as Mi,bq as Z,aQ as ae,aq as en,f as fo,W as Wn,bA as f$1,bB as Ni,cG as Ct,a7 as AT,s as sc,a8 as RT,M as Mb,d as dy,am as T_,aa as Dy,ab as Cf,ac as bf,G as GT,m as WT,j as ja,y as yf,bC as s_,bD as Sy,aZ as cc,cE as Ki,aX as ac,a9 as ic,v as v_,ah as $T,R as Ry,k as kT,x as xT,P as PT,u as by}from'./main-NLT5B5MV.js';var vt=["knob"],gt=["valueIndicatorContainer"];function bt(s,c){if(s&1&&(ja(0,"div",2,1)(2,"div",5)(3,"span",6),v_(4),yf()()()),s&2){let t=$T();Mb(4),Ry(t.valueIndicatorText);}}var Tt=["trackActive"],kt=["*"];function It(s,c){if(s&1&&sc(0,"div"),s&2){let t=c.$implicit,i=c.$index,e=$T(3);s_(t===0?"mdc-slider__tick-mark--active":"mdc-slider__tick-mark--inactive"),by("transform",e._calcTickMarkTransform(i));}}function Rt(s,c){if(s&1&&kT(0,It,1,4,"div",8,xT),s&2){let t=$T(2);PT(t._tickMarks);}}function xt(s,c){if(s&1&&(ja(0,"div",6,1),AT(2,Rt,2,0),yf()),s&2){let t=$T();Mb(2),RT(t._cachedWidth?2:-1);}}function yt(s,c){if(s&1&&sc(0,"mat-slider-visual-thumb",7),s&2){let t=$T();dy("discrete",t.discrete)("thumbPosition",1)("valueIndicatorText",t.startValueIndicatorText);}}var n=(function(s){return s[s.START=1]="START",s[s.END=2]="END",s})(n||{}),f=(function(s){return s[s.ACTIVE=0]="ACTIVE",s[s.INACTIVE=1]="INACTIVE",s})(f||{}),P=new E("_MatSlider"),ct=new E("_MatSliderThumb"),Mt=new E("_MatSliderRangeThumb"),mt=new E("_MatSliderVisualThumb");var St=(()=>{class s{_cdr=p(fr);_ngZone=p(K);_slider=p(P);_renderer=p(lo);_listenerCleanups;discrete=false;thumbPosition;valueIndicatorText;_ripple;_knob;_valueIndicatorContainer;_sliderInput;_sliderInputEl;_hoverRippleRef;_focusRippleRef;_activeRippleRef;_isHovered=false;_isActive=false;_isValueIndicatorVisible=false;_hostElement=p(xt$1).nativeElement;_platform=p(he);ngAfterViewInit(){let t=this._slider._getInput(this.thumbPosition);t&&(this._ripple.radius=24,this._sliderInput=t,this._sliderInputEl=this._sliderInput._hostElement,this._ngZone.runOutsideAngular(()=>{let i=this._sliderInputEl,e=this._renderer;this._listenerCleanups=[e.listen(i,"pointermove",this._onPointerMove),e.listen(i,"pointerdown",this._onDragStart),e.listen(i,"pointerup",this._onDragEnd),e.listen(i,"pointerleave",this._onMouseLeave),e.listen(i,"focus",this._onFocus),e.listen(i,"blur",this._onBlur)];}));}ngOnDestroy(){this._listenerCleanups?.forEach(t=>t());}_onPointerMove=t=>{if(this._sliderInput._isFocused)return;let i=this._hostElement.getBoundingClientRect(),e=this._slider._isCursorOnSliderThumb(t,i);this._isHovered=e,e?this._showHoverRipple():this._hideRipple(this._hoverRippleRef);};_onMouseLeave=()=>{this._isHovered=false,this._hideRipple(this._hoverRippleRef);};_onFocus=()=>{this._hideRipple(this._hoverRippleRef),this._showFocusRipple(),this._hostElement.classList.add("mdc-slider__thumb--focused");};_onBlur=()=>{this._isActive||this._hideRipple(this._focusRippleRef),this._isHovered&&this._showHoverRipple(),this._hostElement.classList.remove("mdc-slider__thumb--focused");};_onDragStart=t=>{t.button===0&&(this._isActive=true,this._showActiveRipple());};_onDragEnd=()=>{this._isActive=false,this._hideRipple(this._activeRippleRef),this._sliderInput._isFocused||this._hideRipple(this._focusRippleRef),this._platform.SAFARI&&this._showHoverRipple();};_showHoverRipple(){this._isShowingRipple(this._hoverRippleRef)||(this._hoverRippleRef=this._showRipple({enterDuration:0,exitDuration:0}),this._hoverRippleRef?.element.classList.add("mat-mdc-slider-hover-ripple"));}_showFocusRipple(){this._isShowingRipple(this._focusRippleRef)||(this._focusRippleRef=this._showRipple({enterDuration:0,exitDuration:0},true),this._focusRippleRef?.element.classList.add("mat-mdc-slider-focus-ripple"));}_showActiveRipple(){this._isShowingRipple(this._activeRippleRef)||(this._activeRippleRef=this._showRipple({enterDuration:225,exitDuration:400}),this._activeRippleRef?.element.classList.add("mat-mdc-slider-active-ripple"));}_isShowingRipple(t){return t?.state===l.FADING_IN||t?.state===l.VISIBLE}_showRipple(t,i){if(!this._slider.disabled&&(this._showValueIndicator(),this._slider._isRange&&this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)._showValueIndicator(),!(this._slider._globalRippleOptions?.disabled&&!i)))return this._ripple.launch({animation:this._slider._noopAnimations?{enterDuration:0,exitDuration:0}:t,centered:true,persistent:true})}_hideRipple(t){if(t?.fadeOut(),this._isShowingAnyRipple())return;this._slider._isRange||this._hideValueIndicator();let i=this._getSibling();i._isShowingAnyRipple()||(this._hideValueIndicator(),i._hideValueIndicator());}_showValueIndicator(){this._hostElement.classList.add("mdc-slider__thumb--with-indicator");}_hideValueIndicator(){this._hostElement.classList.remove("mdc-slider__thumb--with-indicator");}_getSibling(){return this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)}_getValueIndicatorContainer(){return this._valueIndicatorContainer?.nativeElement}_getKnob(){return this._knob.nativeElement}_isShowingAnyRipple(){return this._isShowingRipple(this._hoverRippleRef)||this._isShowingRipple(this._focusRippleRef)||this._isShowingRipple(this._activeRippleRef)}static \u0275fac=function(i){return new(i||s)};static \u0275cmp=hf({type:s,selectors:[["mat-slider-visual-thumb"]],viewQuery:function(i,e){if(i&1&&Dy(Ct,5)(vt,5)(gt,5),i&2){let a;Cf(a=bf())&&(e._ripple=a.first),Cf(a=bf())&&(e._knob=a.first),Cf(a=bf())&&(e._valueIndicatorContainer=a.first);}},hostAttrs:[1,"mdc-slider__thumb","mat-mdc-slider-visual-thumb"],inputs:{discrete:"discrete",thumbPosition:"thumbPosition",valueIndicatorText:"valueIndicatorText"},features:[T_([{provide:mt,useExisting:s}])],decls:4,vars:2,consts:[["knob",""],["valueIndicatorContainer",""],[1,"mdc-slider__value-indicator-container"],[1,"mdc-slider__thumb-knob"],["matRipple","",1,"mat-focus-indicator",3,"matRippleDisabled"],[1,"mdc-slider__value-indicator"],[1,"mdc-slider__value-indicator-text"]],template:function(i,e){i&1&&(AT(0,bt,5,1,"div",2),sc(1,"div",3,0)(3,"div",4)),i&2&&(RT(e.discrete?0:-1),Mb(3),dy("matRippleDisabled",true));},dependencies:[Ct],styles:[`.mat-mdc-slider-visual-thumb .mat-ripple {
  height: 100%;
  width: 100%;
}
